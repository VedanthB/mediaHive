  ...
  return (
    <footer
      ...
      <div className="text-grey-700">
        Made with
        <span className="text-amber-700 font-bold ml-1 mr-1">&lt;/&gt; </span> by
        <a
      ...
      <div className="flex mt-3 align-items-center justify-center">
        ...
        <a href="https://twitter.com/vedanth_X0X0" target="_blank" rel="noreferrer">
          <i className="fab fa-twitter mr-2 text-amber-700"></i>
        </a>
        <a href="https://www.linkedin.com/in/vedanth-bora/" target="_blank" rel="noreferrer">
